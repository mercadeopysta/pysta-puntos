...
export default function NuevaFacturaClient() {
  ...
  const subirArchivo = async () => {
    ...
    const { data } = supabase.storage.from("invoice-files").getPublicUrl(fileName)
      ...
      <InfoPopup
        ...
        message={
          editInvoiceId
            ...
            : "Cuando registres una nueva factura, esta quedará pendiente de aprobación mientras es revisada por administración."
        }
      />
            ...
            >
              <div style={{ marginBottom: "22px" }}>
                ...
                <p style={{ margin: "8px 0 0 0", color: "#6b7280", lineHeight: 1.5 }}>
                  Completa la información y adjunta la foto o PDF de la factura.
                </p>
              </div>
